...
description: ""
---
# omc-teams (portable claude-safe)
...
1. Project-local transferred bundle: `.claude/skills/omc-teams/SKILL.md`.
2. Active Claude config directory: `$CLAUDE_CONFIG_DIR/skills/omc-teams/SKILL.md` (or `[$CLAUDE_CONFIG_DIR|~/.claude]/skills/omc-teams/SKILL.md`).
3. Sibling generated tree path relative to this command file: `../skills/omc-teams/SKILL.md`.
4. Legacy/package path if the session is launched from an OMC checkout: `skills/omc-teams/SKILL.md`.
5. Optional plugin roots only if present and permitted by `claude-safe`: `$CLAUDE_PLUGIN_ROOT/skills/omc-teams/SKILL.md` or `$OMC_PLUGIN_ROOT/skills/omc-teams/SKILL.md`.
